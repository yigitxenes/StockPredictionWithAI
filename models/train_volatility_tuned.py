...
from models.train_volatility_baseline import prepare_features, get_feature_cols
...
def main():
    ...
    print(f"Dataset: {dataset_file}, {len(feature_cols)} feature")
    ...
    for model_family in ["xgboost", "lightgbm"]:
        ...
        print(f"\n{model_family} -- Fold Summary:")
        print(metrics_df.describe().loc[["mean", "std"]])

        print(f"\n{model_family} -- Best parameters per fold:")
